...
function renderMissingValues() {
  ...
  mvComment.className = 'analysis-comment';
...
function renderSummaryStats() {
  ...
  numComment.className = 'analysis-comment';
  ...
  catComment.className = 'analysis-comment';
...
function renderCharts() {
  ...
  numericCols.forEach(col=>{
    ...
    histComment.className = 'analysis-comment';
  ...
  corrComment.className = 'analysis-comment';
